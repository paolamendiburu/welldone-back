...
from articles.api import ArticleViewSet, MyArticleViewSet, SearchViewSet,  MyFavoritesViewSet, UserViewSet, HighlightViewSet, CategoryViewSet, CommentViewSet, FollowViewSet, FavoriteViewSet
...
router.register('my-favorites', MyFavoritesViewSet,
                base_name='api-favorites-mine')
router.register('comments', CommentViewSet, base_name='comments')
router.register('search-bar', SearchViewSet, base_name='api-search-bar')
router.register('follows', FollowViewSet, base_name='follows')
router.register('favorites', FavoriteViewSet, base_name='favorites')
router.register('highlight', HighlightViewSet, base_name='highlight')
